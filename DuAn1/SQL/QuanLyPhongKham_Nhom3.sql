...
CREATE TABLE BENHAN  (
	...
	MaDT nchar(15)  null,
	MaPhong varchar(15) null	,
	CONSTRAINT  FK_BA_NV FOREIGN KEY (MaNV) REFERENCES NHANVIEN (MaNV),
	CONSTRAINT  FK_BA_BN FOREIGN KEY (MaBN) REFERENCES BENHNHAN (MaBN),
	CONSTRAINT  FK_BA_VP FOREIGN KEY (MaVP) REFERENCES VIENPHI (MaVP),
	CONSTRAINT  FK_BA_LK FOREIGN KEY (MaLichKham) REFERENCES LICHKHAM (MaLichKham),
	CONSTRAINT  FK_BA_HDT FOREIGN KEY (MaDT) REFERENCES HOADONTHUOC (MaDT),
	CONSTRAINT  FK_BA_PHONG FOREIGN KEY (MaPhong) REFERENCES PHONG (MaPhong),
...
--('BA01','2020-03-25','bsi08','BN01','VP01','LK0001','DT01','P012'),
--('BA02','2022-06-12','bsi20','BN14','VP13','LK0003','DT14','P031'),
--('BA03','2022-03-28','bsi15','BN13','VP12','LK0010','DT13','P029'),
--('BA04','2022-4-25','bsi03','BN16','VP15','LK0008','DT16','P023'),
--('BA05','2021-06-12','bsi03','BN17','VP16','LK0011','DT17','P024'),
--('BA06','2021-06-12','bsi15','BN20','VP19','LK0012','DT20','P029'),
--('BA07','2021-05-25','bsi18','BN19','VP08','LK0013','DT08','P015'),
--('BA08','2021-12-13','bsi18','BN18','VP09','LK0014','DT09','P018'),
--('BA09','2021-9-12','bsi18','BN14','VP09','LK0016','DT15','P029')
...
AS
BEGIN
SELECT A.MABN, HoTenBN, COUNT(A.MaBN)AS N'Số lần khám' FROM BENHAN  A INNER JOIN BENHNHAN N ON A.MaBN = N.MaBN GROUP BY A.MaBN, HoTenBN
END
go
...
AS
BEGIN
SELECT A.MABN, HoTenBN, COUNT(A.MaBN)AS N'Số lần khám' FROM BENHAN  A INNER JOIN BENHNHAN N ON A.MaBN = N.MaBN GROUP BY A.MaBN, HoTenBN,A.NgayKham having YEAR(A.NgayKham) =@NAM
END
...
AS
BEGIN
SELECT A.MABN, HoTenBN, COUNT(A.MaBN)AS N'Số lần khám' FROM BENHAN  A INNER JOIN BENHNHAN N ON A.MaBN = N.MaBN GROUP BY A.MaBN, HoTenBN,A.NgayKham having MONTH(A.NgayKham) =@THANG AND YEAR(A.NgayKham) =@NAM
END
go
...
AS
BEGIN
SELECT A.MABN, HoTenBN, A.NgayKham,A.MaNV,HoTenNV,TenKhoa FROM BENHAN  A INNER JOIN BENHNHAN N ON A.MaBN = N.MaBN inner join NHANVIEN V  ON A.MaNV = V.MaNV INNER JOIN KHOA K ON V.MaKhoa = K.MaKhoa GROUP BY A.MABN, HoTenBN, A.NgayKham,A.MaNV,HoTenNV,TenKhoa HAVING A.MaBN = @MABN
END
go
