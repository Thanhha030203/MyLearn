...
//bị gì nữa
    ...
    private void initComponents() {
        ...
        if (tblHDCT.getColumnModel().getColumnCount() > 0) {
            tblHDCT.getColumnModel().getColumn(1).setHeaderValue("Title 2");
            tblHDCT.getColumnModel().getColumn(2).setHeaderValue("Title 3");
            tblHDCT.getColumnModel().getColumn(3).setHeaderValue("Title 4");
            tblHDCT.getColumnModel().getColumn(4).setHeaderValue("Title 5");
        }
