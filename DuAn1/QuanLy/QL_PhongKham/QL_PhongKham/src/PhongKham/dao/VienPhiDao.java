...
public class VienPhiDao  extends ClinicDao<VienPhiPK, String>{
   ...
   private List<Object[]> getListOfArray(String sql, String[] cols, Object... args) {
      ...
      public Float getTienTh(String MaDT) {
         String sql="select Sum(HDCT.Soluong*THUOC.DonGia)  from HOADONCHITIET HDCT JOIN THUOC ON  HDCT.MaThuoc = THUOC.MaThuoc where MaDT = '?' group by MaDT";
        Float TienThuoc = null;
        TienThuoc = Float.valueOf(this.selectBySql(sql, MaDT).toString());
        return TienThuoc;
    }
      
//         public float selectByMaDT1(String maDT) {
