...
@NamedQueries({
	@NamedQuery(name = "Video.find_Video_ByID",query = "Select o from Video o where ID =:id"),
	@NamedQuery(name = "Video.find_Video_ByFavorite",query = "Select o.video from Favorite o where o.video.ID =:id"),
	@NamedQuery(name = "Video.find_Video_ByUserId",query = "Select o.video from Favorite o where o.user.ID =:id"),
