...
<body style="background-color:rgb(240, 243, 244);">
    ...
    <div>
        <header class="container-fluid  mb-3 pos" style="background-color: white; z-index: 999;">
            ...
            <div class="row ">
                ...
                <div class="col-sm-2 mt-2 mb-4">
                    <div class="d-flex flex-nowrap me-2" style="font-size:14px; line-height: 50px;">
                        <div class="flex-fill text-center text-decoration-none"><a href="#"
                    ...
                    <div class="card pt-2" data-bs-toggle="card">
                        <div class="card pt-2  border-0" data-bs-toggle="card">
                            <div class="text-center">
                                <iframe width="90%" height="500px" src="https://www.youtube.com/embed/pzQ2d16B9Z8"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-5 con">
                                    <a href="#"> <img src="images/onepiece.jfif" width="95%" height="100px" alt=""></a>
                                    <div class="More_product_user"><div class="text_a"><a href="#"><img src="icons/play.png" alt=""></a></div></div>
                                </div>
                                <div class="col-sm-7 pt-3">
                                    <a href="#">
                                        <h6>Waiting for you/ Mono /lyric</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-2">
                    <div class="card" data-bs-toggle="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-5 con">
                                    <a href="#"> <img src="images/images (1).jfif" width="95%" height="100px"
                                            alt=""></a>
                                            <div class="More_product_user"><div class="text_a"><a href="#"><img src="icons/play.png" alt=""></a></div></div>
                                </div>
                                <div class="col-sm-7 pt-3">
                ...
                <div class="mt-2">
                    <div class="card" data-bs-toggle="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-5 con">
                                    <a href="#"> <img src="images/images.jfif" width="95%" height="100px" alt=""></a>
                                    <div class="More_product_user"><div class="text_a"><a href="#"><img src="icons/play.png" alt=""></a></div></div>
                                </div>
                                <div class="col-sm-7 pt-3">
                                    <a href="#">
                ...
                <div class="mt-2">
                    <div class="card" data-bs-toggle="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-5 con">
                                    <a href="#"> <img src="images/jusukaise.jfif" width="95%" height="100px" alt=""></a>
                                    <div class="More_product_user"><div class="text_a"><a href="#"><img src="icons/play.png" alt=""></a></div></div>
                                </div>
                                <div class="col-sm-7 pt-3">
                                    <a href="#">
                ...
                <div class="mt-2">
                    <div class="card" data-bs-toggle="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-5 con">
                                    <a href="#"> <img src="images/mavel.jfif" width="95%" height="100px" alt=""></a>
                                    <div class="More_product_user"><div class="text_a"><a href="#"><img src="icons/play.png" alt=""></a></div></div>
                                </div>
                                <div class="col-sm-7 pt-3">
                                    <a href="#">
