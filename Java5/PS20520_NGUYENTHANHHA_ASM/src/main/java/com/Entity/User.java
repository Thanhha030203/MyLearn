...
@NamedQueries({
	@NamedQuery(name = "User.find_User_ByID",query = "Select o from User o where o.ID =:id"),
	@NamedQuery(name = "User.find_User_ByID_PASSWORD",query = "Select o from User o where o.ID =:id AND o.PASSWORD =:password"),
	@NamedQuery(name = "User.find_User_ByID_PASSWORD_ADMIN",query = "Select o from User o where o.ID =:id AND o.PASSWORD =:password and o.ADMIN=:role"),
