			...
			<div class="row">
				<div class="col-md-2 bg-white">
					<div class="list-group list-group-flush">
						<a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" > Favorite Video  <span class="badge bg-primary rounded-pill">${countuserlike}</span></a> 
							<a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"> Share Video  <span class="badge bg-primary rounded-pill">${countusershare}</span></a>
							 <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">My Video<span class="badge bg-primary rounded-pill">0</span></a>
					</div>
				</div>
				<div class="col-md-4 ">
					<div>
							...
							<div class="card-body">
								<div class="float-end">
									<button class="btn btn-success" formaction="">
										<a href="../asm/dislikeVideo?IdOfVideolike=${productVideo.ID}" >Dislike</a>
									</button>
									<button class="btn "
										style="background-color: #ff6a00; color: white;" formaction="">
										<a href="../asm/shareVideo?IdOfVideo=${productVideo.ID}">Share</a>
									</button>
								</div>
							</div>
						</div>
									...
									<div class="row">
										<div class="col-sm-5 con">
											...
											<div class="More_product_user">
												<div class="text_a">
													<a href="product?videoId=${videolist.ID}"><img
														src="../icons/play.png" alt=""></a>
												</div>
											</div>
										</div>
