											...
											<div>
												<div class="float-start">
													<label class="from-label">ID/Username :</label> <label
														class="from-label">${user.ID}</label>
												</div>
											...
											<div>
												<div class="float-start">
													<label class="from-label">Password :</label> <label
														class="from-label">${user.PASSWORD}</label>
												</div>

												<div class="float-end">
													<label class="from-label"><a href="../asm/change-password">Edit</a></label>
												</div>
											</div>
										</li>
										<li class="list-group-item">
											<div>
												<div class="float-start">
													<label class="from-label">FullName :</label> <label
														class="from-label">${user.FULLNAME}</label>
												</div>
											...
											<div>
												<div class="float-start">
													<label class="from-label">Email :</label> <label
														class="from-label">${user.EMAIL}</label>
												</div>
