...
public class DichVu  {
    ...
    String TenCTy, email,zalo;
    int SDT;
    String website,DiaChi,GhiChu;

    public DichVu(String MaDV, String TenDV, double PhiDV, String NgayPhatHanh, String HanKetThuc, String TenCTy, String email, int SDT, String website,String zalo, String DiaChi, String GhiChu) {
        this.MaDV = MaDV;
        this.TenDV = TenDV;
        this.PhiDV = PhiDV;
