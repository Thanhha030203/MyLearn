...
public class NhaTro extends LoaiNhaTro {
    ...
    public NhaTro(String MaNT, String TenNT, String DiaChi, int dientich, String Mota, String MaLoai, double gia, String Ma_NLH, boolean TrangThai, String Hinh, String MalOai) {
        super(MalOai);
        this.MaNT = MaNT;
        this.TenNT = TenNT;
        this.DiaChi = DiaChi;
    ...
    public String toString() {
        return "NhaTro{" + "MaNT=" + MaNT + ", TenNT=" + TenNT + ", DiaChi=" + DiaChi + ", dientich=" + dientich + ", Mota=" + Mota + ", MaLoai=" + MaLoai + ", gia=" + gia + ", Ma_NLH=" + Ma_NLH + ", TrangThai=" + TrangThai + ", Hinh=" + Hinh + '}';
    }
