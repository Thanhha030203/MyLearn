...
public class NhaTroDao implements QuanLyDao<NhaTro, String> {
    ...
    public void insert(NhaTro entity) {
        ...
        insert_sql = "Insert into NhaTro values('" + entity.getMaNT() + "', N'" + entity.getTenNT() + "', N'" + entity.getDiaChi() + "', " + entity.getDientich() + ", N'"+entity.getMota()+"', '" + entity.getMaLoai() + "',"+entity.getGia()+",'"+entity.getMa_NLH()+"',"+trangthai+", N'"+entity.getHinh()+"')";
        System.out.println("tại íner 34 "+ insert_sql);
        try {
    ...
    public NhaTro Select_ID(String id) {
        ...
        selectld_sql = "Select * from NhaTro n inner join LoaiNhaTro l on n.MaLoai = l.MaLoai and MaNT = '" + id + "'";
        try {
