...
('MG11', '0934123789', 'ngobakha123',     'kha123','no'),
('MG43', '0864136263', 'hayenminh223',    'minh1993','no'),
('MG22', '0945180092', 'nhamngocuyen356', 'uyen1989','no'),
('MG13', '0783799033', 'daovubang769',    'bang2000','no'),
('MG31', '0986789214', 'thienminhquoc234','quoc1998','no'),
('MG15', '0976893119', 'tranminhdao123',  'dao1995','no'),
('MG36', '0865789043', 'hotrongty222',    'ty2001','no'),
('MH01', '0964738294', 'phamthanhha321',  'ha2003','no'),
('MH02', '0703865323', 'havanminh454',    'minh1995','no'),
('MH03', '0337578234', 'lethienkhang121', 'khang2002','no'),
('MH04', '0493859239', 'thingocqui789',   'qui1997','no'),
('MH05', '0908637836', 'trantamcang090',  'cang1996','no');
...
('DV001VN', N'Clean_house','kha1990@gmail.com' , '0934123744',N'http://wwwcleanhouse.com.vn',N'http://zalo.cleanhouse.com.vn', N'1358 Quang Trung, Phường 14, Quận Gò Vấp, TP.Hồ Chí Minh'     , N'Bạn hãy tư vấn về dịch vụ dọn trọ của bên mình'),
('DV003VN',N'Bank_connect', 'minh1993@gmail.com', '0864136353',N'http://wwwbankconnect.com.vn',N'http://zalo.bankconnect.com.vn', N'28/2A, Phường Linh Chiểu, Quận Thủ Đức, TP.Hồ Chí Minh'       ,N'Dịch vụ dọn trọ bên mình sẽ làm những gì vậy'),
('DV004VN',N'Go_Live', 'uyen1989@gmail.com', '0945180092',N'http://wwwgolive.com.vn',N'http://zalo.golive.com.vn', N'Hoàng Diệu 2, Phường Linh Chiểu, Quận Thủ Đức, TP.Hồ Chí Minh', N'Mình không biết cách nạp tiền nhờ bạn hãy tư vấn '),
('DV005VN',N'Global', 'bang2000@gmail.com', '0783799033',N'http://wwwglobal.com.vn',N'http://zalo.global.com.vn', N'Dương Quảng Hàm, Phường 5, Quận Gò Vấp, TP.Hồ Chí Minh'       , N'Về phần liên kết thẻ rất khó hiểu mong bạn tư vấn cho mình'),
('DV002VN',N'MoCo_CityNow', 'cang1996@gmail.com', '0908637836',N'http://wwwmococity.com.vn',N'http://zalo.mococity.com.vn', N'Trần Phú Cương, Phường 7, Quận Gò Vấp, TP.Hồ Chí Minh'        , N'Bạn tư vấn cho mình kĩ hơn về dịch vụ quảng cáo nhà trọ'),
('DV007VN',N'Dev_Post', 'cang1996@gmail.com', '0908637836',N'http://wwwdevpost.com.vn',N'http://zalo.devpost.com.vn', N'Trần Phú Cương, Phường 8, Quận Gò Vấp, TP.Hồ Chí Minh'        , N'Bạn tư vấn cho mình kĩ hơn về dịch vụ quảng cáo nhà trọ'),
('DV008VN', N'Vin_OFF','cang1996@gmail.com', '0908637836',N'http://wwwvinoff.com.vn',N'http://zalo.vinoff.com.vn', N'Trung Mỹ Tây , Quận 12, TP.Hồ Chí Minh'        ,N'Bạn tư vấn cho mình kĩ hơn về dịch vụ quảng cáo nhà trọ'),
('DV009VN',N'Sara_Call', 'cang1996@gmail.com', '0908637836', N'http://wwwsaracall.com.vn',N'http://zalosaracall.com.vn', N'Trần Phú Cương, Phường 14, Quận Gò Vấp, TP.Hồ Chí Minh'        , N'Bạn tư vấn cho mình kĩ hơn về dịch vụ quảng cáo nhà trọ');
INSERT INTO DanhSach_DangKy_DichVu VALUES
('DV001VN', 'MG11', '2022-06-12',2, '1',0),
('DV001VN', 'MG43', '2022-07-22',1, '1',0),
('DV001VN', 'MG22', '2022-08-15',4, '1',1),
('DV001VN', 'MG13', '2022-10-23',1, '1',1),
('DV003VN', 'MG31', '2022-06-09', 1, '1',0),
('DV001VN', 'MG15', '2022-08-10', 3, '1',0),
('DV002VN', 'MG36', '2022-09-05', 2, '1',1),
('DV001VN', 'MH01', '2022-08-25', 1, '1',0),
('DV001VN', 'MH02', '2022-09-30', 3, '1',1),
('DV001VN', 'MH03', '2022-06-24',3, '1',1),
('DV006VN', 'MH04', '2022-08-08', 7, '1',0),
('DV001VN', 'MH05', '2022-07-18', 4, '1',1),
('DV001VN', 'MG15', '2022-10-11', 1, '0',1),
('DV001VN', 'MG36', '2022-10-28',1, '0',0),
('DV007VN', 'MH01', '2022-09-03', 2, '1',0),
('DV001VN', 'MH02', '2022-07-08', 1, '1',0),
('DV002VN', 'MH03', '2022-07-13', 3, '1',0),
('DV002VN', 'MH04', '2022-08-18',5, '1',1),
('DV001VN', 'MH05', '2022-08-01', 1, '1',1);
...
END
drop trigger INSERT_TAIKHOAN
go
CREATE TRIGGER INSERT_TAIKHOAN ON TaiKhoan FOR INSERT
AS
BEGIN
Declare @id int = (Select SUBSTRING(Max(MaTK),3,2) as INT from TaiKhoan);
		UPDATE TaiKhoan SET MaTK= CONCAT('MH0',Cast(@id as int)+1) WHERE MaTK IN (SELECT MaTK FROM inserted);
END

drop trigger INSERT_GiaoDich
go
CREATE TRIGGER INSERT_GiaoDich ON GiaoDich FOR INSERT
AS
BEGIN
Declare @id int = (Select SUBSTRING(Max(MaGD),5,4) as INT from GiaoDich);
		UPDATE GiaoDich SET MAGD= CONCAT('GDVN',Cast(@id as int)+1) WHERE MAGD IN (SELECT MAGD FROM inserted);
END

drop trigger INSERT_LienKet
go
CREATE TRIGGER INSERT_Lienket ON LienKetThe_Vi  FOR INSERT
AS
BEGIN
Declare @id int = (Select SUBSTRING(Max(MaLK),4,4) as INT from LienKetThe_Vi);
		UPDATE LienKetThe_Vi SET MaLK= CONCAT('LKT',Cast(@id as int)+1,'VN') WHERE MaLK IN (SELECT MaLK FROM inserted);
END
...
select * from NguoiDung d inner join TaiKhoan k on d.SDT = k.SDT and UserName = 'havanminh454'
