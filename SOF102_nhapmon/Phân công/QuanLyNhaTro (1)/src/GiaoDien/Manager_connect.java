 ...
 */
public class Manager_connect extends javax.swing.JFrame {

    /**
     * Creates new form Manager_connect
     */
    public Manager_connect() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã người dùng", "Tên người dùng", "CMND", "Username", "Ngày liên kết", "Tên ngân hàng", "Số thẻ", "Số tài khoản", "Số dư", "Trạng thái"
            }
        ));
        ...
        jLabel11.setText("Manager_Connect");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manager_connect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manager_connect().setVisible(true);
            }
        });
    }
