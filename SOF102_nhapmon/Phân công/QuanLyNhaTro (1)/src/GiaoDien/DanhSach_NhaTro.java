...
public class DanhSach_NhaTro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpanelHinh = new javax.swing.JPanel();
        ...
        jpanelHinh.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        javax.swing.GroupLayout jpanelHinhLayout = new javax.swing.GroupLayout(jpanelHinh);
        jpanelHinh.setLayout(jpanelHinhLayout);
        jpanelHinhLayout.setHorizontalGroup(
            jpanelHinhLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 131, Short.MAX_VALUE)
        );
        jpanelHinhLayout.setVerticalGroup(
            jpanelHinhLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );

        jPanel1.add(jpanelHinh, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 36, -1, 151));
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        nt.setMaNT(txtMaNha.getText());
        nt.setTenNT(txtTenNha.getText());
        nt.setMa_NLH(txtNgLienHe.getText());
        nt.setDientich(Integer.valueOf(txtDienTich.getText()));
    ...
    private void tblBangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBangMouseClicked
        // TODO add your handling code here:
    int index = tblBang.getSelectedRow();
    NhaTro stu = list.get(current);
    txtMaNha.setText(stu.getMaNT());
    txtTenNha.setText(stu.getTenNT());
    txtNgLienHe.setText(stu.getMa_NLH());
    txtDiaChi.setText(stu.getDiaChi());
    txtMoTa.setText(stu.getMota());
    ...
    private javax.swing.JPanel jpanelHinh;
