...
//    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, -1, -1));
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        System.out.println("123 mẻmee "+ tk.getRemember());
        if (tk == null) {
            ...
            if (!tk.getPassword().equals(txtpass.getText())) {
                ...
                trangchu trangchu = new trangchu(User_Login.user);
