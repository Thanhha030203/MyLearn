...
public class ThanhToan_DichVu extends javax.swing.JFrame {
    ...
    public void check(LienKet lk) throws SQLException {
        ...
        if (this.tongphi <= lk.getSoDu()) {
            ...
            dk_dv.setTrangthaithanhtoan(true) ;
            new DangKy_DichVuDao().updates(dk_dv,user.getMaTK());
            gd = new GiaoDich("GDVN0000", dk_dv.getTenDV(), 9808373, user.getMaTK() + " Thanh toán dịch vụ ", ngayThanhToan, tongphi, true, lk.getMaLK(), lk.getMaTK(), lk.getTenNganHang(), lk.getSoThe(), lk.getSoTK(), lk.getSoDu());
            new GiaoDichDao().insert(gd);
            JOptionPane.showMessageDialog(null, "Giao dịch thành công");
        } else {
            JOptionPane.showMessageDialog(null, "thanh toán thất bại");
            gd = new GiaoDich("GDVN0000", dk_dv.getTenDV(), 9808373, user.getMaTK() + " Thanh toán dịch vụ ", ngayThanhToan, tongphi, false, lk.getMaLK(), lk.getMaTK(), lk.getTenNganHang(), lk.getSoThe(), lk.getSoTK(), lk.getSoDu());
            new GiaoDichDao().insert(gd);
        }
        addRow();
    }
