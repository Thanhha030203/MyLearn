...
public class DangKy_DichVuDao implements QuanLyDao <DangKy_DichVu, String>{
    ...
    public void insert(DangKy_DichVu entity) {
                int trangthaidangki = (entity.isTrangThaiDangKy())?0:1;
    ...
    public void update(DangKy_DichVu entity) {
        ...
        int trangthaidangki = (entity.isTrangThaiDangKy())?0:1;
        int trangthaithanhtoan = (entity.isTrangthaithanhtoan())?1:0;
        update_sql = "Update  DanhSach_DangKy_DichVu set MaTK = '"+entity.getMaTK()+"', NgayDangKy = '"+entity.getNgayDangKy()+"', ThoiHan_Thang = '"+entity.getThoiHan()+"', TrangThaiDangKy = '"+trangthaidangki+"', TrangThaiThanhToan = '"+trangthaithanhtoan+"' where MaDV = '"+entity.getMaDV()+"' and MaTK='"+matk+"' ";
        try {
            con.getResult(update_sql);
        } catch (SQLException ex) {
            Logger.getLogger(DangKy_DichVuDao.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void delete(DangKy_DichVu entity) {
        ...
        public void deletes(DangKy_DichVu entity,String matk) {
