...
public class GiaoDichDao implements QuanLyDao<GiaoDich, String> {
    ...
    public void insert(GiaoDich entity) {
        ...
        insert_sql = "Insert into GiaoDich values('" + entity.getMaGD() + "', '" + entity.getMaLK() + "', N'" + entity.getTenGD() + "', '" + entity.getMaTK() + "', " + entity.getSoTK() + ", " + entity.getSoTk_nguoinhan() + ", N'" + entity.getNoiDung() + "', " + entity.getThoigian() + ", " + entity.getSoTien() + ", " + trangthai + ")";
        try {
