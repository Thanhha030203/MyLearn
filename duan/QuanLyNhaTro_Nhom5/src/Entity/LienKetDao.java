...
public class LienKetDao implements QuanLyDao<LienKet, String>{
    ...
    public void insert(LienKet entity) {
        ...
        insert_sql = "Insert into LienKetThe_Vi values('"+entity.getMaLK()+"', '"+entity.getMaTK()+"', N'"+entity.getTenNganHang()+"', "+entity.getSoThe()+", "+entity.getSoTK()+", "+trangthai+", "+entity.getSoDu()+")";
        try {
    ...
    public void update(LienKet entity) {
        int trangthai = (entity.isTrangthai())?1:0;
        update_sql = "Update LienKetThe_Vi set TenNganHang = '"+entity.getTenNganHang()+"',SoThe = "+entity.getSoThe()+" ,TrangThai = "+trangthai+", SoTk = "+entity.getSoTK()+",SoDu = "+entity.getSoDu()+" where MaTK = '"+entity.getMaTK()+"'";
        try {
    ...
    public void delete(LienKet entity) {
        delete_sql = "Delete From LienKetThe_Vi where MaLK = N'"+entity.getMaLK()+"'";
        try {
    ...
    public LienKet Select_ID(String id) {
        ...
        selectld_sql = "Select * from LienKetThe_Vi where MaTK = '"+id+"'";
        try {
    ...
    public List<LienKet> SelectAll() {
        ...
        LienKet lk = new LienKet();
        selectall_sql = "Select * from LienKetThe_Vi" ;
        try {
