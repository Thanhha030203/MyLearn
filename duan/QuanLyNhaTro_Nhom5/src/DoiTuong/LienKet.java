...
public class LienKet extends TaiKhoan {
    ...
    public LienKet(String MaLK,String MaTK, String TenNganHang, int soThe, int SoTK, boolean trangthai, double soDu,String ngayphathanh) {
        this.MaLK = MaLK;
        this.MaTK = MaTK;
        this.TenNganHang = TenNganHang;
        this.soThe = soThe;
    ...
    public LienKet(String MaLK, String MaTK, String TenNganHang, int soThe, int SoTK, double soDu) {
        this.MaLK = MaLK;
        this.MaTK = MaTK;
        this.TenNganHang = TenNganHang;
        this.soThe = soThe;
