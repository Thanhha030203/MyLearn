...
public class EduSysJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("HE THONG QUAN LY DAO TAO");
        ...
        mniDoiMatKhau.setText("Doi mat khau");
        ...
        mniLuongNguoiHoc.setText("luong nguoi hoc");
        ...
        mniDiemChuyenDe.setText("Diem chuyen de");
    ...
    void openThongKe(int index){
        if(Auth.isLogin()){
            if(index == 3 && !Auth.isManager()){
                MsgBox.alert(this, "Bạn không có quyen xem thông tin doanh thu");
                return;
            }
