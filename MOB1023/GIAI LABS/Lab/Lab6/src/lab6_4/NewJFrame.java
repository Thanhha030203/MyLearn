...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btmDonVi = new javax.swing.JButton();
        ...
        btmDonVi.setText("Start");
        btmDonVi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmDonViActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnTram, javax.swing.GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE))
                .addGap(84, 84, 84)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel2)
                    .addComponent(txtChuc, javax.swing.GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btmDonVi, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        // TODO add your handling code here:
          Thread thread = new Thread (new Runnable(){
            ...
            public void run(){
                for (int i = 0; i < 1000; i++) { 
                int tram = (int)(Math.random()*10);
                txtChuc.setText(String.valueOf(tram));
                try {
                    Thread.sleep(10);
                } catch (InterruptedException ex) {
                    Logger.getLogger(NewJFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btmDonViActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmDonViActionPerformed
        // TODO add your handling code here:
          Thread thread = new Thread (new Runnable(){
            @Override
            public void run(){
                for (int i = 0; i < 1000; i++) { 
                int tram = (int)(Math.random()*10);
                txtDonVi.setText(String.valueOf(tram));
                try {
                    Thread.sleep(10);
                } catch (InterruptedException ex) {
                    Logger.getLogger(NewJFrame.class.getName()).log(Level.SEVERE, null, ex);
        ...
        thread.start();
    }//GEN-LAST:event_btmDonViActionPerformed
    ...
    private javax.swing.JButton btmDonVi;
