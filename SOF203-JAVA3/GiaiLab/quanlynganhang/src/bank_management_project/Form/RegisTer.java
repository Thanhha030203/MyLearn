...
public class RegisTer extends javax.swing.JFrame {
    ...
    private static final String DATABASE_USER_NAME = "PS20520-THANHHA";
    private static final String DATABASE_PASSWORD = "30022031";
    private int index = -1;
    ...
    private void jButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegisterActionPerformed
        ...
        if(validateForm()) {
            if (len != 10) {
                ...
                JOptionPane.showMessageDialog(this, "So can cuoc phai du 12 so");
                return;
            }
            if ( pw >= 6  ) {
                JOptionPane.showMessageDialog(this, "Mat khau phai lon hon hoac bang 6");
                return;
            }
            if ( pw <= 20  ) {
                JOptionPane.showMessageDialog(this, "Mat khau phai nho hon hoac bang 20");
                return;
            }
            ...
            try {
                ...
                String query = "INSERT INTO register  VALUES ('" + first_name + "','" + last_name + "','" + user_code + "','" + password + "','" + email_id + "','" + mobile_number + "','" + dia_chi + "','" + cccd + "','" + gioi_tinh + "')";
                ...
                int stk = ranNum;
                String query1 = "INSERT INTO Login  VALUES('" + stk + "','" + password + "')";
