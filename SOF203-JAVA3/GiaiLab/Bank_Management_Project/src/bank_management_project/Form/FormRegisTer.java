...
public class FormRegisTer extends javax.swing.JFrame {
    ...
    private static final String DATABASE_URL = "jdbc:sqlserver://localhost;databaseName=QUANLINGANHANG;";
    ...
    public boolean validateForm() {
        if(txtfName.getText().equals("")&&txtLName.getText().equals("")&&txtUser.getText().equals("")&&txtGmail.getText().equals("")&&txtPass.getText().equals("")&&txtConfirmPass.getText().equals("")&&txtPhone.getText().equals("")){
    ...
    /**
     * Creates new form FormRegisTerForm
     */
    ...
    private void initComponents() {
        ...
        txtDiaChiCap = new javax.swing.JTextField();
        ...
        jLabel14.setText("Ngay cap");

        jLabel16.setBackground(new java.awt.Color(240, 240, 240));
        jLabel16.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(236, 240, 241));
        jLabel16.setText("Ðia chi cap");

        txtDiaChiCap.setBackground(new java.awt.Color(102, 102, 102));
        txtDiaChiCap.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtDiaChiCap.setForeground(new java.awt.Color(204, 204, 255));
        ...
        txtNgayCap.setBackground(new java.awt.Color(102, 102, 102));
        txtNgayCap.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtNgayCap.setForeground(new java.awt.Color(204, 204, 255));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(txtDiaChiCap, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtNgayCap, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtDiaChiCap, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegisterActionPerformed
        ...
        String DATE_RANGE = txtNgayCap.getText();
        String ISSUED_BY = txtDiaChiCap.getText();
        String ADDRESS_USER = txtDiaChi.getText();
        String PHONE = txtPhone.getText();
        String GMAIL = txtGmail.getText();
        String PASS = txtPass.getText();
        int len = PHONE.length();
        int passs = PASS.length();
        if(validateForm()) {
            if (len != 10) {
            ...
            try {
                ...
                String query = "INSERT INTO USERS VALUES ('" + USER_CODE + "','" + FIRST_NAME + "','" + LAST_NAME + "','" + SEX + "','" + BRITH + "','" + IDENTITY_CARD_OR_CITIZEN_IDENTIFICATION + "','" + DATE_RANGE + "','" + ISSUED_BY + "','" + ADDRESS_USER + "','" + GMAIL + "','" + PASS + "')";
    ...
    private javax.swing.JTextField txtDiaChiCap;
