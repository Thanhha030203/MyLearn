...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtSTK, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        if (txtSTK.getText().equals("") && txtPass.getText().equals("")) {
            ...
            try {
                String bdurl = "jdbc:sqlserver://localhost;databaseName=QUANLY_NGANHANG;user=sa;password=123";
                Connection conn = DriverManager.getConnection(bdurl);
                String sql = "SELECT * FROM LOGIN Where ACCOUNT_NUMBER=? AND PASSWORD=?";
                PreparedStatement ps = conn.prepareStatement(sql);
                ps.setString(1, txtSTK.getText());
                ps.setString(2, txtPass.getText());
                ResultSet rs = ps.executeQuery();
                String ACCOUNT_NUMBER = txtSTK.getText();
                int account = ACCOUNT_NUMBER.length();
                if (rs.next()) {
                    if (account == 3) {
