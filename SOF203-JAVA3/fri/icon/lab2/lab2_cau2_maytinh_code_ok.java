 ...
 */
public class lab2_cau2_maytinh_code_ok extends javax.swing.JFrame {
    // 1. Khai báo bên ngoài nút 2 biến 
    long a = 0; // Khai báo số thứ nhất
    String pheptoan = ""; // khai báo biến pheptoan
    
    /**
     * Creates new form lab2_cau2_matinh
     */
    public lab2_cau2_maytinh_code_ok() {
        initComponents();
    }
    ...
    private void btnSo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo1ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo1.getText()); //2. cộng dồn vào gt
            
            //3. Hiện thị lên txtSo
            txtSo.setText(String.valueOf(so)); // nhớ ép qua kiểu String          
        }
    ...
    private void btnSo2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo2ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo2.getText()); //2. cộng dồn vào gt
    ...
    private void btnSo3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo3ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo3.getText()); //2. cộng dồn vào gt
    ...
    private void btnChiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChiaActionPerformed
        ...
        pheptoan = "/" ; //2. xác định click vào nút phép toán nào
        //3. gán txtSo về 0 để chuẩn bị nhập số thứ 2
        txtSo.setText("0");  
    ...
    private void btnSo4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo4ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo4.getText()); //2. cộng dồn vào gt
    ...
    private void btnSo5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo5ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo5.getText()); //2. cộng dồn vào gt
    ...
    private void btnSo6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo6ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo6.getText()); //2. cộng dồn vào gt
    ...
    private void btnSo7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo7ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo7.getText()); //2. cộng dồn vào gt
    ...
    private void btnSo8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo8ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo8.getText()); //2. cộng dồn vào gt
    ...
    private void btnSo9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo9ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo9.getText()); //2. cộng dồn vào gt
    ...
    private void btnSo0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSo0ActionPerformed
        ...
        if (gt.length() < 12)
        {
            ...
            long so = Long.parseLong(gt + btnSo0.getText()); //2. cộng dồn vào gt
...
//        txtSo.setText(""+kq);
        ...
        //1. lấy giá trị trên txtSo gán cho biến b
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lab2_cau2_maytinh_code_ok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lab2_cau2_maytinh_code_ok().setVisible(true);
            }
        });
    }
