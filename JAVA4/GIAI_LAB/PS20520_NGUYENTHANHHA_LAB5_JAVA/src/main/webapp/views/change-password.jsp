	...
	<div class="container">
		<div style="width: 50%; margin: 10px auto; border: 1px solid #666">
			<form action="" style="margin: 20px 30px">
				...
				<hr>
				<button class="btn" formaction="/PS20520_NGUYENTHANHHA_LAB5_JAVA/account/change-password" formmethod="post">Update</button>
				<button class="btn" formaction="/PS20520_NGUYENTHANHHA_LAB5_JAVA/account/edit-profile">Home</button>
			</form>
			<div
