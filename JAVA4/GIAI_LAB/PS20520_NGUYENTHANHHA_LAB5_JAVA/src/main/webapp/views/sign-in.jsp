		...
		<div class="container">
			<div style="width: 50%; margin: 10px auto; border: 1px solid #666">
				<form style="margin: 20px 30px">
					...
					<button formaction="/PS20520_NGUYENTHANHHA_LAB5_JAVA/account/sign-in" formmethod="post"  class="btn">Sign-in</button>
					<span class="vr"></span>
					<button formaction="/PS20520_NGUYENTHANHHA_LAB5_JAVA/account/sign-up"  class="btn">No account</button>
					<button formaction="/PS20520_NGUYENTHANHHA_LAB5_JAVA/account/forgot-password"  class="btn">Forgot password</button>
				</form>
				<hr>
