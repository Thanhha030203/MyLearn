...
<body>
	<div class="container">
		<div style="width: 30%; height: 500px; margin:20px auto;">
			<div class ="card" data-bs-toggle="card">
				...
				<div class="card-body">
					<div>
						<img alt="" style="width: 100%; height: 300px" src="images/${item.image}">	
					</div>
					<div>
						<ul>
							<li>Giá gốc : ${item.price}</li>
							<li>Giá mới : <c:set  var ="newprice" value="${item.price *(1-item.discount)}"></c:set> 
