...
public class ClientGUI extends JFrame {
	...
	setTitle("Hỗ trợ khách hàng Rabbit Ví");
	setResizable(false);
	...
	if (lblIp == null) {
	    lblIp = new JLabel("IP ");
	    lblIp.setFont(new Font("Tahoma", Font.BOLD, 17));
	...
	if (lblPort == null) {
	    ...
	    lblPort.setFont(new Font("Tahoma", Font.BOLD, 17));
	...
	if (lblNewLabel_1 == null) {
	    lblNewLabel_1 = new JLabel("Vui lòng nhập thông tin để kết nối");
	...
	if (lblNewLabel_2 == null) {
	    lblNewLabel_2 = new JLabel("Hỗ trợ khách hàng");
