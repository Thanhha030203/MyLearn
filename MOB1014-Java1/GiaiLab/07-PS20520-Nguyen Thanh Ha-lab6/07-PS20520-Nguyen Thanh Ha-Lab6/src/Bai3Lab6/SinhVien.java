...
public class SinhVien {
    ...
    public void nhap() {
        ...
        do {
            ...
            } while (!this.diemToan.matches(repDiem));
           do {                
                 System.out.print("Nhap diem Hoa : ");
            this.diemHoa = sc.nextLine();
            } while ((!this.diemHoa.matches(repDiem)));
           do {                
                 System.out.print("Nhap diem Ly : ");
            this.diemLy = sc.nextLine();
            } while ((!this.diemLy.matches(repDiem)));
    ...
    public String toString() {
        return "SinhVien [" +"Ten sv = "+ ten+ ", email = " + email + ", sdt = " + sdt + ", CMND = " + CMND + ", diemToan = " + diemToan + ", diemLy = " + diemLy + ", diemHoa = " + diemHoa + "DTB = "+ trungBinh() + ", Xep loai = "+xeploai() +']';
    }
}
