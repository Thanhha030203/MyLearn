...
-- Y6.7---
SELECT CH.TENCH, COUNT(PX.MACH) as" SỐ LẦN NHẬP HÀNG", CT.SOLUONG*HH.DONGIA AS"TIỀN THANH TOÁN" 
FROM CUAHANG CH INNER JOIN PHIEUXUAT PX ON CH.MACH = PX.MACH 
 INNER JOIN CTPHIEUXUAT CT 
ON PX.SOPHIEU = CT.SOPHIEU INNER JOIN HANGHOA HH ON CT.MAHH = HH.MAHH GROUP BY PX.MACH having  CH.TENCH = "Vân Thanh Fashion – Chi nhánh Quận 3"  ;
-- Y6.8---
